...
`;var E=class{constructor(t,...e){this.slotNames=[],this.handleSlotChange=o=>{let i=o.target;(this.slotNames.includes("[default]")&&!i.name||i.name&&this.slotNames.includes(i.name))&&this.host.requestUpdate()},(this.host=t).addController(this),this.slotNames=e}hasDefaultSlot(){return[...this.host.childNodes].some(t=>{if(t.nodeType===t.TEXT_NODE&&t.textContent.trim()!=="")return!0;if(t.nodeType===t.ELEMENT_NODE){let e=t;if(e.tagName.toLowerCase()==="sl-visually-hidden")return!1;if(!e.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(t){return this.host.querySelector(`:scope > [slot="${t}"]`)!==null}test(t){return t==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(t)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}};function Ui(t){if(!t)return"";let e=t.assignedNodes({flatten:!0}),o="";return[...e].forEach(i=>{i.nodeType===Node.TEXT_NODE&&(o+=i.textContent)}),o}var Fo="";function pe(t){Fo=t}function yo(t=""){if(!Fo){let e=[...document.getElementsByTagName("script")],o=e.find(i=>i.hasAttribute("data-shoelace"));if(o)pe(o.getAttribute("data-shoelace"));else{let i=e.find(r=>/shoelace(\.min)?\.js($|\?)/.test(r.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(r.src)),s="";i&&(s=i.getAttribute("src")),pe(s.split("/").slice(0,-1).join("/"))}}return Fo.replace(/\/$/,"")+(t?`/${t.replace(/^\//,"")}`:"")}var hr={name:"default",resolver:t=>yo(`assets/icons/${t}.svg`)},Fi=hr;var yi={caret:`
  ...
  `},pr={name:"system",resolver:t=>t in yi?`data:image/svg+xml,${encodeURIComponent(yi[t])}`:""},Ii=pr;var Re=[Fi,Ii],je=[];function Ci(t){je.push(t)}function fi(t){je=je.filter(e=>e!==t)}function Io(t){return Re.find(e=>e.name===t)}function Ee(t,e){Li(t),Re.push({name:t,resolver:e.resolver,mutator:e.mutator,spriteSheet:e.spriteSheet}),je.forEach(o=>{o.library===t&&o.setIcon()})}function Li(t){Re=Re.filter(e=>e.name!==t)}var vi=y`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
...
`;function W(t,e){let o=H({waitUntilFirstUpdate:!1},e);return(i,s)=>{let{update:r}=i,l=Array.isArray(t)?t:[t];i.update=function(c){l.forEach(n=>{let b=n;if(c.has(b)){let g=c.get(b),u=this[b];g!==u&&(!o.waitUntilFirstUpdate||this.hasUpdated)&&this[s](g,u)}}),r.call(this,c)}}}var{I:Ya}=ii;var xi=(t,e)=>e===void 0?t?._$litType$!==void 0:t?._$litType$===e;var Ye=t=>t.strings===void 0;var Qr={},wi=(t,e=Qr)=>t._$AH=e;var Qe=Symbol(),Ve=Symbol(),Co,fo=new Map,z=class extends C{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(t,e){var o;let i;if(e?.spriteSheet)return this.svg=m`<svg part="svg">
        <use part="use" href="${t}"></use>
      </svg>`,this.svg;try{if(i=await fetch(t,{mode:"cors"}),!i.ok)return i.status===410?Qe:Ve}catch{return Ve}try{let s=document.createElement("div");s.innerHTML=await i.text();let r=s.firstElementChild;if(((o=r?.tagName)==null?void 0:o.toLowerCase())!=="svg")return Qe;Co||(Co=new DOMParser);let c=Co.parseFromString(r.outerHTML,"text/html").body.querySelector("svg");return c?(c.part.add("svg"),document.adoptNode(c)):Qe}catch{return Qe}}connectedCallback(){super.connectedCallback(),Ci(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),fi(this)}getIconSource(){let t=Io(this.library);return this.name&&t?{url:t.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var t;let{url:e,fromLibrary:o}=this.getIconSource(),i=o?Io(this.library):void 0;if(!e){this.svg=null;return}let s=fo.get(e);if(s||(s=this.resolveIcon(e,i),fo.set(e,s)),!this.initialRender)return;let r=await s;if(r===Ve&&fo.delete(e),e===this.getIconSource().url){if(xi(r)){if(this.svg=r,i){await this.updateComplete;let l=this.shadowRoot.querySelector("[part='svg']");typeof i.mutator=="function"&&l&&i.mutator(l)}return}switch(r){case Ve:case Qe:this.svg=null,this.emit("sl-error");break;default:this.svg=r.cloneNode(!0),(t=i?.mutator)==null||t.call(i,this.svg),this.emit("sl-load")}}}render(){return this.svg}};z.styles=[L,vi];a([T()],z.prototype,"svg",2);a([d({reflect:!0})],z.prototype,"name",2);a([d()],z.prototype,"src",2);a([d()],z.prototype,"label",2);a([d({reflect:!0})],z.prototype,"library",2);a([W("label")],z.prototype,"handleLabelChange",1);a([W(["name","src","library"])],z.prototype,"setIcon",1);var it={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Tt=t=>(...e)=>({_$litDirective$:t,values:e}),At=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,o,i){this._$Ct=e,this._$AM=o,this._$Ci=i}_$AS(e,o){return this.update(e,o)}update(e,o){return this.render(...o)}};var A=Tt(class extends At{constructor(t){if(super(t),t.type!==it.ATTRIBUTE||t.name!=="class"||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(this.st===void 0){this.st=new Set,t.strings!==void 0&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(let i in e)e[i]&&!this.nt?.has(i)&&this.st.add(i);return this.render(e)}let o=t.element.classList;for(let i of this.st)i in e||(o.remove(i),this.st.delete(i));for(let i in e){let s=!!e[i];s===this.st.has(i)||this.nt?.has(i)||(s?(o.add(i),this.st.add(i)):(o.remove(i),this.st.delete(i)))}return j}});var Ai=Symbol.for(""),mr=t=>{if(t?.r===Ai)return t?._$litStatic$};var qt=(t,...e)=>({_$litStatic$:e.reduce((o,i,s)=>o+(r=>{if(r._$litStatic$!==void 0)return r._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${r}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(i)+t[s+1],t[0]),r:Ai}),Ni=new Map,Lo=t=>(e,...o)=>{let i=o.length,s,r,l=[],c=[],n,b=0,g=!1;for(;b<i;){for(n=e[b];b<i&&(r=o[b],(s=mr(r))!==void 0);)n+=s+e[++b],g=!0;b!==i&&c.push(r),l.push(n),b++}if(b===i&&l.push(e[i]),g){let u=l.join("$$lit$$");(e=Ni.get(u))===void 0&&(l.raw=l,Ni.set(u,e=l)),o=c}return t(e,...o)},Pt=Lo(m),pn=Lo(Po),Qn=Lo(ti);var B=t=>t??D;var w=class extends C{constructor(){super(...arguments),this.formControlController=new Se(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new E(this,"[default]","prefix","suffix"),this.localize=new G(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:Te}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(t){this.isButton()&&(this.button.setCustomValidity(t),this.formControlController.updateValidity())}render(){let t=this.isLink(),e=t?qt`a`:qt`button`;return Pt`
      <${e}
        part="base"
...
`;var k=class extends C{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){let t=!!this.href,e=t?qt`a`:qt`button`;return Pt`
    ...
    `}};k.styles=[L,Gi];k.dependencies={"sl-icon":z};a([x(".icon-button")],k.prototype,"button",2);a([T()],k.prototype,"hasFocus",2);a([d()],k.prototype,"name",2);a([d()],k.prototype,"library",2);a([d()],k.prototype,"src",2);a([d()],k.prototype,"href",2);a([d()],k.prototype,"target",2);a([d()],k.prototype,"download",2);a([d()],k.prototype,"label",2);a([d({type:Boolean,reflect:!0})],k.prototype,"disabled",2);var ki=new Map,Fr=new WeakMap;function yr(t){return t??{keyframes:[],options:{duration:0}}}function Xi(t,e){return e.toLowerCase()==="rtl"?{keyframes:t.rtlKeyframes||t.keyframes,options:t.options}:t}function K(t,e){ki.set(t,yr(e))}function $(t,e,o){let i=Fr.get(t);if(i?.[e])return Xi(i[e],o.dir);let s=ki.get(e);return s?Xi(s,o.dir):{keyframes:[],options:{duration:0}}}function Bt(t,e){return new Promise(o=>{function i(s){s.target===t&&(t.removeEventListener(e,i),o())}t.addEventListener(e,i)})}function q(t,e,o){return new Promise(i=>{if(o?.duration===1/0)throw new Error("Promise-based animations must be finite.");let s=t.animate(e,Nt(H({},o),{duration:Ir()?0:o.duration}));s.addEventListener("cancel",i,{once:!0}),s.addEventListener("finish",i,{once:!0})})}function Ir(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function st(t){return Promise.all(t.getAnimations().map(e=>new Promise(o=>{e.cancel(),requestAnimationFrame(o)})))}var Zi=y`
  :host {
    display: contents;
...
`;var te=Object.assign(document.createElement("div"),{className:"sl-toast-stack"}),Y=class extends C{constructor(){super(...arguments),this.hasSlotController=new E(this,"icon","suffix"),this.localize=new G(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){var t;(t=this.countdownAnimation)==null||t.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){var t;this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),(t=this.countdownAnimation)==null||t.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){let{countdownElement:t}=this,e="100%",o="0";this.countdownAnimation=t.animate([{width:e},{width:o}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.duration<1/0&&this.restartAutoHide(),await st(this.base),this.base.hidden=!1;let{keyframes:t,options:e}=$(this,"alert.show",{dir:this.localize.dir()});await q(this.base,t,e),this.emit("sl-after-show")}else{this.emit("sl-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await st(this.base);let{keyframes:t,options:e}=$(this,"alert.hide",{dir:this.localize.dir()});await q(this.base,t,e),this.base.hidden=!0,this.emit("sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,Bt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,Bt(this,"sl-after-hide")}async toast(){return new Promise(t=>{this.handleCountdownChange(),te.parentElement===null&&document.body.append(te),te.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("sl-after-hide",()=>{te.removeChild(this),t(),te.querySelector("sl-alert")===null&&te.remove()},{once:!0})})}render(){return m`
    ...
    `}};Y.styles=[L,Zi];Y.dependencies={"sl-icon-button":k};a([x('[part~="base"]')],Y.prototype,"base",2);a([x(".alert__countdown-elapsed")],Y.prototype,"countdownElement",2);a([d({type:Boolean,reflect:!0})],Y.prototype,"open",2);a([d({type:Boolean,reflect:!0})],Y.prototype,"closable",2);a([d({reflect:!0})],Y.prototype,"variant",2);a([d({type:Number})],Y.prototype,"duration",2);a([d({type:String,reflect:!0})],Y.prototype,"countdown",2);a([T()],Y.prototype,"remainingTime",2);a([W("open",{waitUntilFirstUpdate:!0})],Y.prototype,"handleOpenChange",1);a([W("duration")],Y.prototype,"handleDurationChange",1);K("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});K("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});Y.define("sl-alert");var Si=y`
  :host {
    display: inline-block;
...
`;var rt=class extends C{constructor(){super(...arguments),this.hasError=!1,this.image="",this.label="",this.initials="",this.loading="eager",this.shape="circle"}handleImageChange(){this.hasError=!1}handleImageLoadError(){this.hasError=!0,this.emit("sl-error")}render(){let t=m`
      <img
        part="image"
        class="avatar__image"
        src="${this.image}"
    ...
    `}};rt.styles=[L,Si];rt.dependencies={"sl-icon":z};a([T()],rt.prototype,"hasError",2);a([d()],rt.prototype,"image",2);a([d()],rt.prototype,"label",2);a([d()],rt.prototype,"initials",2);a([d()],rt.prototype,"loading",2);a([d({reflect:!0})],rt.prototype,"shape",2);a([W("image")],rt.prototype,"handleImageChange",1);rt.define("sl-avatar");var Ti=y`
  .breadcrumb {
    display: flex;
    align-items: center;
    flex-wrap: wrap;
  }
`;var Rt=class extends C{constructor(){super(...arguments),this.localize=new G(this),this.separatorDir=this.localize.dir(),this.label=""}getSeparator(){let e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll("[id]")].forEach(o=>o.removeAttribute("id")),e.setAttribute("data-default",""),e.slot="separator",e}handleSlotChange(){let t=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()==="sl-breadcrumb-item");t.forEach((e,o)=>{let i=e.querySelector('[slot="separator"]');i===null?e.append(this.getSeparator()):i.hasAttribute("data-default")&&i.replaceWith(this.getSeparator()),o===t.length-1?e.setAttribute("aria-current","page"):e.removeAttribute("aria-current")})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),m`
    ...
    `}};Rt.styles=[L,Ti];Rt.dependencies={"sl-icon":z};a([x("slot")],Rt.prototype,"defaultSlot",2);a([x('slot[name="separator"]')],Rt.prototype,"separatorSlot",2);a([d()],Rt.prototype,"label",2);Rt.define("sl-breadcrumb");var Ri=y`
  :host {
    display: inline-flex;
  }
...
`;var Ut=class extends C{constructor(){super(...arguments),this.hasSlotController=new E(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}setRenderType(){let t=this.defaultSlot.assignedElements({flatten:!0}).filter(e=>e.tagName.toLowerCase()==="sl-dropdown").length>0;if(this.href){this.renderType="link";return}if(t){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return m`
    ...
    `}};Ut.styles=[L,Ri];a([x("slot:not([name])")],Ut.prototype,"defaultSlot",2);a([T()],Ut.prototype,"renderType",2);a([d()],Ut.prototype,"href",2);a([d()],Ut.prototype,"target",2);a([d()],Ut.prototype,"rel",2);a([W("href",{waitUntilFirstUpdate:!0})],Ut.prototype,"hrefChanged",1);Ut.define("sl-breadcrumb-item");var ji=y`
  :host {
...
`;var vo=class extends C{constructor(){super(...arguments),this.hasSlotController=new E(this,"footer","header","image")}render(){return m`
      <div
        part="base"
...
`;var lt=class extends C{constructor(){super(...arguments),this.hasSlotController=new E(this,"footer"),this.localize=new G(this),this.modal=new Ji(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=t=>{t.key==="Escape"&&this.modal.isActive()&&this.open&&(t.stopPropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),No(this))}disconnectedCallback(){var t;super.disconnectedCallback(),this.modal.deactivate(),Ao(this),(t=this.closeWatcher)==null||t.destroy()}requestClose(t){if(this.emit("sl-request-close",{cancelable:!0,detail:{source:t}}).defaultPrevented){let o=$(this,"dialog.denyClose",{dir:this.localize.dir()});q(this.panel,o.keyframes,o.options);return}this.hide()}addOpenListeners(){var t;"CloseWatcher"in window?((t=this.closeWatcher)==null||t.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){var t;(t=this.closeWatcher)==null||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),No(this);let t=this.querySelector("[autofocus]");t&&t.removeAttribute("autofocus"),await Promise.all([st(this.dialog),st(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("sl-initial-focus",{cancelable:!0}).defaultPrevented||(t?t.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),t&&t.setAttribute("autofocus","")});let e=$(this,"dialog.show",{dir:this.localize.dir()}),o=$(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([q(this.panel,e.keyframes,e.options),q(this.overlay,o.keyframes,o.options)]),this.emit("sl-after-show")}else{this.emit("sl-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([st(this.dialog),st(this.overlay)]);let t=$(this,"dialog.hide",{dir:this.localize.dir()}),e=$(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([q(this.overlay,e.keyframes,e.options).then(()=>{this.overlay.hidden=!0}),q(this.panel,t.keyframes,t.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,Ao(this);let o=this.originalTrigger;typeof o?.focus=="function"&&setTimeout(()=>o.focus()),this.emit("sl-after-hide")}}async show(){if(!this.open)return this.open=!0,Bt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,Bt(this,"sl-after-hide")}render(){return m`
    ...
    `}};lt.styles=[L,Hi];lt.dependencies={"sl-icon-button":k};a([x(".dialog")],lt.prototype,"dialog",2);a([x(".dialog__panel")],lt.prototype,"panel",2);a([x(".dialog__overlay")],lt.prototype,"overlay",2);a([d({type:Boolean,reflect:!0})],lt.prototype,"open",2);a([d({reflect:!0})],lt.prototype,"label",2);a([d({attribute:"no-header",type:Boolean,reflect:!0})],lt.prototype,"noHeader",2);a([W("open",{waitUntilFirstUpdate:!0})],lt.prototype,"handleOpenChange",1);K("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});K("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});K("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}});K("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});K("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});lt.define("sl-dialog");var _i=y`
  :host {
...
`;var Be=class extends C{constructor(){super(...arguments),this.vertical=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}};Be.styles=[L,_i];a([d({type:Boolean,reflect:!0})],Be.prototype,"vertical",2);a([W("vertical")],Be.prototype,"handleVerticalChange",1);Be.define("sl-divider");var Ki=y`
  :host {
    display: inline-block;
  }
...
`;var gt=Math.min,R=Math.max,Fe=Math.round,ye=Math.floor,at=t=>({x:t,y:t}),Ar={left:"right",right:"left",bottom:"top",top:"bottom"},Or={start:"end",end:"start"};function Ke(t,e,o){return R(t,gt(e,o))}function jt(t,e){return typeof t=="function"?t(e):t}function Ft(t){return t.split("-")[0]}function Et(t){return t.split("-")[1]}function Oo(t){return t==="x"?"y":"x"}function $e(t){return t==="y"?"height":"width"}function Ot(t){return["top","bottom"].includes(Ft(t))?"y":"x"}function qe(t){return Oo(Ot(t))}function qi(t,e,o){o===void 0&&(o=!1);let i=Et(t),s=qe(t),r=$e(s),l=s==="x"?i===(o?"end":"start")?"right":"left":i==="start"?"bottom":"top";return e.reference[r]>e.floating[r]&&(l=Ue(l)),[l,Ue(l)]}function Pi(t){let e=Ue(t);return[_e(t),e,_e(e)]}function _e(t){return t.replace(/start|end/g,e=>Or[e])}function Wr(t,e,o){let i=["left","right"],s=["right","left"],r=["top","bottom"],l=["bottom","top"];switch(t){case"top":case"bottom":return o?e?s:i:e?i:s;case"left":case"right":return e?r:l;default:return[]}}function ts(t,e,o,i){let s=Et(t),r=Wr(Ft(t),o==="start",i);return s&&(r=r.map(l=>l+"-"+s),e&&(r=r.concat(r.map(_e)))),r}function Ue(t){return t.replace(/left|right|bottom|top/g,e=>Ar[e])}function Dr(t){return{top:0,right:0,bottom:0,left:0,...t}}function Wo(t){return typeof t!="number"?Dr(t):{top:t,right:t,bottom:t,left:t}}function Yt(t){let{x:e,y:o,width:i,height:s}=t;return{width:i,height:s,top:o,left:e,right:e+i,bottom:o+s,x:e,y:o}}function es(t,e,o){let{reference:i,floating:s}=t,r=Ot(e),l=qe(e),c=$e(l),n=Ft(e),b=r==="y",g=i.x+i.width/2-s.width/2,u=i.y+i.height/2-s.height/2,p=i[c]/2-s[c]/2,h;switch(n){case"top":h={x:g,y:i.y-s.height};break;case"bottom":h={x:g,y:i.y+i.height};break;case"right":h={x:i.x+i.width,y:u};break;case"left":h={x:i.x-s.width,y:u};break;default:h={x:i.x,y:i.y}}switch(Et(e)){case"start":h[l]-=p*(o&&b?-1:1);break;case"end":h[l]+=p*(o&&b?-1:1);break}return h}var os=async(t,e,o)=>{let{placement:i="bottom",strategy:s="absolute",middleware:r=[],platform:l}=o,c=r.filter(Boolean),n=await(l.isRTL==null?void 0:l.isRTL(e)),b=await l.getElementRects({reference:t,floating:e,strategy:s}),{x:g,y:u}=es(b,i,n),p=i,h={},Q=0;for(let F=0;F<c.length;F++){let{name:f,fn:I}=c[F],{x:v,y:O,data:X,reset:M}=await I({x:g,y:u,initialPlacement:i,placement:p,strategy:s,middlewareData:h,rects:b,platform:l,elements:{reference:t,floating:e}});g=v??g,u=O??u,h={...h,[f]:{...h[f],...X}},M&&Q<=50&&(Q++,typeof M=="object"&&(M.placement&&(p=M.placement),M.rects&&(b=M.rects===!0?await l.getElementRects({reference:t,floating:e,strategy:s}):M.rects),{x:g,y:u}=es(b,p,n)),F=-1)}return{x:g,y:u,placement:p,strategy:s,middlewareData:h}};async function Pe(t,e){var o;e===void 0&&(e={});let{x:i,y:s,platform:r,rects:l,elements:c,strategy:n}=t,{boundary:b="clippingAncestors",rootBoundary:g="viewport",elementContext:u="floating",altBoundary:p=!1,padding:h=0}=jt(e,t),Q=Wo(h),f=c[p?u==="floating"?"reference":"floating":u],I=Yt(await r.getClippingRect({element:(o=await(r.isElement==null?void 0:r.isElement(f)))==null||o?f:f.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(c.floating)),boundary:b,rootBoundary:g,strategy:n})),v=u==="floating"?{x:i,y:s,width:l.floating.width,height:l.floating.height}:l.reference,O=await(r.getOffsetParent==null?void 0:r.getOffsetParent(c.floating)),X=await(r.isElement==null?void 0:r.isElement(O))?await(r.getScale==null?void 0:r.getScale(O))||{x:1,y:1}:{x:1,y:1},M=Yt(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:c,rect:v,offsetParent:O,strategy:n}):v);return{top:(I.top-M.top+Q.top)/X.y,bottom:(M.bottom-I.bottom+Q.bottom)/X.y,left:(I.left-M.left+Q.left)/X.x,right:(M.right-I.right+Q.right)/X.x}}var is=t=>({name:"arrow",options:t,async fn(e){let{x:o,y:i,placement:s,rects:r,platform:l,elements:c,middlewareData:n}=e,{element:b,padding:g=0}=jt(t,e)||{};if(b==null)return{};let u=Wo(g),p={x:o,y:i},h=qe(s),Q=$e(h),F=await l.getDimensions(b),f=h==="y",I=f?"top":"left",v=f?"bottom":"right",O=f?"clientHeight":"clientWidth",X=r.reference[Q]+r.reference[h]-p[h]-r.floating[Q],M=p[h]-r.reference[h],_=await(l.getOffsetParent==null?void 0:l.getOffsetParent(b)),et=_?_[O]:0;(!et||!await(l.isElement==null?void 0:l.isElement(_)))&&(et=c.floating[O]||r.floating[Q]);let ht=X/2-M/2,dt=et/2-F[Q]/2-1,ot=gt(u[I],dt),It=gt(u[v],dt),bt=ot,Ct=et-F[Q]-It,S=et/2-F[Q]/2+ht,_t=Ke(bt,S,Ct),pt=!n.arrow&&Et(s)!=null&&S!==_t&&r.reference[Q]/2-(S<bt?ot:It)-F[Q]/2<0,ut=pt?S<bt?S-bt:S-Ct:0;return{[h]:p[h]+ut,data:{[h]:_t,centerOffset:S-_t-ut,...pt&&{alignmentOffset:ut}},reset:pt}}});var ss=function(t){return t===void 0&&(t={}),{name:"flip",options:t,async fn(e){var o,i;let{placement:s,middlewareData:r,rects:l,initialPlacement:c,platform:n,elements:b}=e,{mainAxis:g=!0,crossAxis:u=!0,fallbackPlacements:p,fallbackStrategy:h="bestFit",fallbackAxisSideDirection:Q="none",flipAlignment:F=!0,...f}=jt(t,e);if((o=r.arrow)!=null&&o.alignmentOffset)return{};let I=Ft(s),v=Ot(c),O=Ft(c)===c,X=await(n.isRTL==null?void 0:n.isRTL(b.floating)),M=p||(O||!F?[Ue(c)]:Pi(c)),_=Q!=="none";!p&&_&&M.push(...ts(c,F,Q,X));let et=[c,...M],ht=await Pe(e,f),dt=[],ot=((i=r.flip)==null?void 0:i.overflows)||[];if(g&&dt.push(ht[I]),u){let S=qi(s,l,X);dt.push(ht[S[0]],ht[S[1]])}if(ot=[...ot,{placement:s,overflows:dt}],!dt.every(S=>S<=0)){var It,bt;let S=(((It=r.flip)==null?void 0:It.index)||0)+1,_t=et[S];if(_t)return{data:{index:S,overflows:ot},reset:{placement:_t}};let pt=(bt=ot.filter(ut=>ut.overflows[0]<=0).sort((ut,ft)=>ut.overflows[1]-ft.overflows[1])[0])==null?void 0:bt.placement;if(!pt)switch(h){case"bestFit":{var Ct;let ut=(Ct=ot.filter(ft=>{if(_){let Lt=Ot(ft.placement);return Lt===v||Lt==="y"}return!0}).map(ft=>[ft.placement,ft.overflows.filter(Lt=>Lt>0).reduce((Lt,Ss)=>Lt+Ss,0)]).sort((ft,Lt)=>ft[1]-Lt[1])[0])==null?void 0:Ct[0];ut&&(pt=ut);break}case"initialPlacement":pt=c;break}if(s!==pt)return{reset:{placement:pt}}}return{}}}};async function Mr(t,e){let{placement:o,platform:i,elements:s}=t,r=await(i.isRTL==null?void 0:i.isRTL(s.floating)),l=Ft(o),c=Et(o),n=Ot(o)==="y",b=["left","top"].includes(l)?-1:1,g=r&&n?-1:1,u=jt(e,t),{mainAxis:p,crossAxis:h,alignmentAxis:Q}=typeof u=="number"?{mainAxis:u,crossAxis:0,alignmentAxis:null}:{mainAxis:u.mainAxis||0,crossAxis:u.crossAxis||0,alignmentAxis:u.alignmentAxis};return c&&typeof Q=="number"&&(h=c==="end"?Q*-1:Q),n?{x:h*g,y:p*b}:{x:p*b,y:h*g}}var rs=function(t){return t===void 0&&(t=0),{name:"offset",options:t,async fn(e){var o,i;let{x:s,y:r,placement:l,middlewareData:c}=e,n=await Mr(e,t);return l===((o=c.offset)==null?void 0:o.placement)&&(i=c.arrow)!=null&&i.alignmentOffset?{}:{x:s+n.x,y:r+n.y,data:{...n,placement:l}}}}},ls=function(t){return t===void 0&&(t={}),{name:"shift",options:t,async fn(e){let{x:o,y:i,placement:s}=e,{mainAxis:r=!0,crossAxis:l=!1,limiter:c={fn:f=>{let{x:I,y:v}=f;return{x:I,y:v}}},...n}=jt(t,e),b={x:o,y:i},g=await Pe(e,n),u=Ot(Ft(s)),p=Oo(u),h=b[p],Q=b[u];if(r){let f=p==="y"?"top":"left",I=p==="y"?"bottom":"right",v=h+g[f],O=h-g[I];h=Ke(v,h,O)}if(l){let f=u==="y"?"top":"left",I=u==="y"?"bottom":"right",v=Q+g[f],O=Q-g[I];Q=Ke(v,Q,O)}let F=c.fn({...e,[p]:h,[u]:Q});return{...F,data:{x:F.x-o,y:F.y-i,enabled:{[p]:r,[u]:l}}}}}};var as=function(t){return t===void 0&&(t={}),{name:"size",options:t,async fn(e){var o,i;let{placement:s,rects:r,platform:l,elements:c}=e,{apply:n=()=>{},...b}=jt(t,e),g=await Pe(e,b),u=Ft(s),p=Et(s),h=Ot(s)==="y",{width:Q,height:F}=r.floating,f,I;u==="top"||u==="bottom"?(f=u,I=p===(await(l.isRTL==null?void 0:l.isRTL(c.floating))?"start":"end")?"left":"right"):(I=u,f=p==="end"?"top":"bottom");let v=F-g.top-g.bottom,O=Q-g.left-g.right,X=gt(F-g[f],v),M=gt(Q-g[I],O),_=!e.middlewareData.shift,et=X,ht=M;if((o=e.middlewareData.shift)!=null&&o.enabled.x&&(ht=O),(i=e.middlewareData.shift)!=null&&i.enabled.y&&(et=v),_&&!p){let ot=R(g.left,0),It=R(g.right,0),bt=R(g.top,0),Ct=R(g.bottom,0);h?ht=Q-2*(ot!==0||It!==0?ot+It:R(g.left,g.right)):et=F-2*(bt!==0||Ct!==0?bt+Ct:R(g.top,g.bottom))}await n({...e,availableWidth:ht,availableHeight:et});let dt=await l.getDimensions(c.floating);return Q!==dt.width||F!==dt.height?{reset:{rects:!0}}:{}}}};function to(){return typeof window<"u"}function Vt(t){return cs(t)?(t.nodeName||"").toLowerCase():"#document"}function V(t){var e;return(t==null||(e=t.ownerDocument)==null?void 0:e.defaultView)||window}function nt(t){var e;return(e=(cs(t)?t.ownerDocument:t.document)||window.document)==null?void 0:e.documentElement}function cs(t){return to()?t instanceof Node||t instanceof V(t).Node:!1}function P(t){return to()?t instanceof Element||t instanceof V(t).Element:!1}function ct(t){return to()?t instanceof HTMLElement||t instanceof V(t).HTMLElement:!1}function ns(t){return!to()||typeof ShadowRoot>"u"?!1:t instanceof ShadowRoot||t instanceof V(t).ShadowRoot}function oe(t){let{overflow:e,overflowX:o,overflowY:i,display:s}=tt(t);return/auto|scroll|overlay|hidden|clip/.test(e+i+o)&&!["inline","contents"].includes(s)}function ds(t){return["table","td","th"].includes(Vt(t))}function Ie(t){return[":popover-open",":modal"].some(e=>{try{return t.matches(e)}catch{return!1}})}function eo(t){let e=oo(),o=P(t)?tt(t):t;return o.transform!=="none"||o.perspective!=="none"||(o.containerType?o.containerType!=="normal":!1)||!e&&(o.backdropFilter?o.backdropFilter!=="none":!1)||!e&&(o.filter?o.filter!=="none":!1)||["transform","perspective","filter"].some(i=>(o.willChange||"").includes(i))||["paint","layout","strict","content"].some(i=>(o.contain||"").includes(i))}function bs(t){let e=yt(t);for(;ct(e)&&!Jt(e);){if(eo(e))return e;if(Ie(e))return null;e=yt(e)}return null}function oo(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}function Jt(t){return["html","body","#document"].includes(Vt(t))}function tt(t){return V(t).getComputedStyle(t)}function Ce(t){return P(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.scrollX,scrollTop:t.scrollY}}function yt(t){if(Vt(t)==="html")return t;let e=t.assignedSlot||t.parentNode||ns(t)&&t.host||nt(t);return ns(e)?e.host:e}function us(t){let e=yt(t);return Jt(e)?t.ownerDocument?t.ownerDocument.body:t.body:ct(e)&&oe(e)?e:us(e)}function ee(t,e,o){var i;e===void 0&&(e=[]),o===void 0&&(o=!0);let s=us(t),r=s===((i=t.ownerDocument)==null?void 0:i.body),l=V(s);if(r){let c=io(l);return e.concat(l,l.visualViewport||[],oe(s)?s:[],c&&o?ee(c):[])}return e.concat(s,ee(s,[],o))}function io(t){return t.parent&&Object.getPrototypeOf(t.parent)?t.frameElement:null}function ps(t){let e=tt(t),o=parseFloat(e.width)||0,i=parseFloat(e.height)||0,s=ct(t),r=s?t.offsetWidth:o,l=s?t.offsetHeight:i,c=Fe(o)!==r||Fe(i)!==l;return c&&(o=r,i=l),{width:o,height:i,$:c}}function Mo(t){return P(t)?t:t.contextElement}function ie(t){let e=Mo(t);if(!ct(e))return at(1);let o=e.getBoundingClientRect(),{width:i,height:s,$:r}=ps(e),l=(r?Fe(o.width):o.width)/i,c=(r?Fe(o.height):o.height)/s;return(!l||!Number.isFinite(l))&&(l=1),(!c||!Number.isFinite(c))&&(c=1),{x:l,y:c}}var zr=at(0);function Qs(t){let e=V(t);return!oo()||!e.visualViewport?zr:{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}}function Gr(t,e,o){return e===void 0&&(e=!1),!o||e&&o!==V(t)?!1:e}function Ht(t,e,o,i){e===void 0&&(e=!1),o===void 0&&(o=!1);let s=t.getBoundingClientRect(),r=Mo(t),l=at(1);e&&(i?P(i)&&(l=ie(i)):l=ie(t));let c=Gr(r,o,i)?Qs(r):at(0),n=(s.left+c.x)/l.x,b=(s.top+c.y)/l.y,g=s.width/l.x,u=s.height/l.y;if(r){let p=V(r),h=i&&P(i)?V(i):i,Q=p,F=io(Q);for(;F&&i&&h!==Q;){let f=ie(F),I=F.getBoundingClientRect(),v=tt(F),O=I.left+(F.clientLeft+parseFloat(v.paddingLeft))*f.x,X=I.top+(F.clientTop+parseFloat(v.paddingTop))*f.y;n*=f.x,b*=f.y,g*=f.x,u*=f.y,n+=O,b+=X,Q=V(F),F=io(Q)}}return Yt({width:g,height:u,x:n,y:b})}function zo(t,e){let o=Ce(t).scrollLeft;return e?e.left+o:Ht(nt(t)).left+o}function ms(t,e,o){o===void 0&&(o=!1);let i=t.getBoundingClientRect(),s=i.left+e.scrollLeft-(o?0:zo(t,i)),r=i.top+e.scrollTop;return{x:s,y:r}}function Xr(t){let{elements:e,rect:o,offsetParent:i,strategy:s}=t,r=s==="fixed",l=nt(i),c=e?Ie(e.floating):!1;if(i===l||c&&r)return o;let n={scrollLeft:0,scrollTop:0},b=at(1),g=at(0),u=ct(i);if((u||!u&&!r)&&((Vt(i)!=="body"||oe(l))&&(n=Ce(i)),ct(i))){let h=Ht(i);b=ie(i),g.x=h.x+i.clientLeft,g.y=h.y+i.clientTop}let p=l&&!u&&!r?ms(l,n,!0):at(0);return{width:o.width*b.x,height:o.height*b.y,x:o.x*b.x-n.scrollLeft*b.x+g.x+p.x,y:o.y*b.y-n.scrollTop*b.y+g.y+p.y}}function kr(t){return Array.from(t.getClientRects())}function Zr(t){let e=nt(t),o=Ce(t),i=t.ownerDocument.body,s=R(e.scrollWidth,e.clientWidth,i.scrollWidth,i.clientWidth),r=R(e.scrollHeight,e.clientHeight,i.scrollHeight,i.clientHeight),l=-o.scrollLeft+zo(t),c=-o.scrollTop;return tt(i).direction==="rtl"&&(l+=R(e.clientWidth,i.clientWidth)-s),{width:s,height:r,x:l,y:c}}function Sr(t,e){let o=V(t),i=nt(t),s=o.visualViewport,r=i.clientWidth,l=i.clientHeight,c=0,n=0;if(s){r=s.width,l=s.height;let b=oo();(!b||b&&e==="fixed")&&(c=s.offsetLeft,n=s.offsetTop)}return{width:r,height:l,x:c,y:n}}function Tr(t,e){let o=Ht(t,!0,e==="fixed"),i=o.top+t.clientTop,s=o.left+t.clientLeft,r=ct(t)?ie(t):at(1),l=t.clientWidth*r.x,c=t.clientHeight*r.y,n=s*r.x,b=i*r.y;return{width:l,height:c,x:n,y:b}}function gs(t,e,o){let i;if(e==="viewport")i=Sr(t,o);else if(e==="document")i=Zr(nt(t));else if(P(e))i=Tr(e,o);else{let s=Qs(t);i={x:e.x-s.x,y:e.y-s.y,width:e.width,height:e.height}}return Yt(i)}function Bs(t,e){let o=yt(t);return o===e||!P(o)||Jt(o)?!1:tt(o).position==="fixed"||Bs(o,e)}function Rr(t,e){let o=e.get(t);if(o)return o;let i=ee(t,[],!1).filter(c=>P(c)&&Vt(c)!=="body"),s=null,r=tt(t).position==="fixed",l=r?yt(t):t;for(;P(l)&&!Jt(l);){let c=tt(l),n=eo(l);!n&&c.position==="fixed"&&(s=null),(r?!n&&!s:!n&&c.position==="static"&&!!s&&["absolute","fixed"].includes(s.position)||oe(l)&&!n&&Bs(t,l))?i=i.filter(g=>g!==l):s=c,l=yt(l)}return e.set(t,i),i}function jr(t){let{element:e,boundary:o,rootBoundary:i,strategy:s}=t,l=[...o==="clippingAncestors"?Ie(e)?[]:Rr(e,this._c):[].concat(o),i],c=l[0],n=l.reduce((b,g)=>{let u=gs(e,g,s);return b.top=R(u.top,b.top),b.right=gt(u.right,b.right),b.bottom=gt(u.bottom,b.bottom),b.left=R(u.left,b.left),b},gs(e,c,s));return{width:n.right-n.left,height:n.bottom-n.top,x:n.left,y:n.top}}function Er(t){let{width:e,height:o}=ps(t);return{width:e,height:o}}function Yr(t,e,o){let i=ct(e),s=nt(e),r=o==="fixed",l=Ht(t,!0,r,e),c={scrollLeft:0,scrollTop:0},n=at(0);if(i||!i&&!r)if((Vt(e)!=="body"||oe(s))&&(c=Ce(e)),i){let p=Ht(e,!0,r,e);n.x=p.x+e.clientLeft,n.y=p.y+e.clientTop}else s&&(n.x=zo(s));let b=s&&!i&&!r?ms(s,c):at(0),g=l.left+c.scrollLeft-n.x-b.x,u=l.top+c.scrollTop-n.y-b.y;return{x:g,y:u,width:l.width,height:l.height}}function Do(t){return tt(t).position==="static"}function hs(t,e){if(!ct(t)||tt(t).position==="fixed")return null;if(e)return e(t);let o=t.offsetParent;return nt(t)===o&&(o=o.ownerDocument.body),o}function Us(t,e){let o=V(t);if(Ie(t))return o;if(!ct(t)){let s=yt(t);for(;s&&!Jt(s);){if(P(s)&&!Do(s))return s;s=yt(s)}return o}let i=hs(t,e);for(;i&&ds(i)&&Do(i);)i=hs(i,e);return i&&Jt(i)&&Do(i)&&!eo(i)?o:i||bs(t)||o}var Vr=async function(t){let e=this.getOffsetParent||Us,o=this.getDimensions,i=await o(t.floating);return{reference:Yr(t.reference,await e(t.floating),t.strategy),floating:{x:0,y:0,width:i.width,height:i.height}}};function Jr(t){return tt(t).direction==="rtl"}var fe={convertOffsetParentRelativeRectToViewportRelativeRect:Xr,getDocumentElement:nt,getClippingRect:jr,getOffsetParent:Us,getElementRects:Vr,getClientRects:kr,getDimensions:Er,getScale:ie,isElement:P,isRTL:Jr};function Hr(t,e){let o=null,i,s=nt(t);function r(){var c;clearTimeout(i),(c=o)==null||c.disconnect(),o=null}function l(c,n){c===void 0&&(c=!1),n===void 0&&(n=1),r();let{left:b,top:g,width:u,height:p}=t.getBoundingClientRect();if(c||e(),!u||!p)return;let h=ye(g),Q=ye(s.clientWidth-(b+u)),F=ye(s.clientHeight-(g+p)),f=ye(b),v={rootMargin:-h+"px "+-Q+"px "+-F+"px "+-f+"px",threshold:R(0,gt(1,n))||1},O=!0;function X(M){let _=M[0].intersectionRatio;if(_!==n){if(!O)return l();_?l(!1,_):i=setTimeout(()=>{l(!1,1e-7)},1e3)}O=!1}try{o=new IntersectionObserver(X,{...v,root:s.ownerDocument})}catch{o=new IntersectionObserver(X,v)}o.observe(t)}return l(!0),r}function Fs(t,e,o,i){i===void 0&&(i={});let{ancestorScroll:s=!0,ancestorResize:r=!0,elementResize:l=typeof ResizeObserver=="function",layoutShift:c=typeof IntersectionObserver=="function",animationFrame:n=!1}=i,b=Mo(t),g=s||r?[...b?ee(b):[],...ee(e)]:[];g.forEach(I=>{s&&I.addEventListener("scroll",o,{passive:!0}),r&&I.addEventListener("resize",o)});let u=b&&c?Hr(b,o):null,p=-1,h=null;l&&(h=new ResizeObserver(I=>{let[v]=I;v&&v.target===b&&h&&(h.unobserve(e),cancelAnimationFrame(p),p=requestAnimationFrame(()=>{var O;(O=h)==null||O.observe(e)})),o()}),b&&!n&&h.observe(b),h.observe(e));let Q,F=n?Ht(t):null;n&&f();function f(){let I=Ht(t);F&&(I.x!==F.x||I.y!==F.y||I.width!==F.width||I.height!==F.height)&&o(),F=I,Q=requestAnimationFrame(f)}return o(),()=>{var I;g.forEach(v=>{s&&v.removeEventListener("scroll",o),r&&v.removeEventListener("resize",o)}),u?.(),(I=h)==null||I.disconnect(),h=null,n&&cancelAnimationFrame(Q)}}var ys=rs;var Is=ls,Cs=ss,Go=as;var fs=is;var Ls=(t,e,o)=>{let i=new Map,s={platform:fe,...o},r={...s.platform,_c:i};return os(t,e,{...s,platform:r})};function vs(t){return _r(t)}function Xo(t){return t.assignedSlot?t.assignedSlot:t.parentNode instanceof ShadowRoot?t.parentNode.host:t.parentNode}function _r(t){for(let e=t;e;e=Xo(e))if(e instanceof Element&&getComputedStyle(e).display==="none")return null;for(let e=Xo(t);e;e=Xo(e)){if(!(e instanceof Element))continue;let o=getComputedStyle(e);if(o.display!=="contents"&&(o.position!=="static"||o.filter!=="none"||e.tagName==="BODY"))return e}return null}function Kr(t){return t!==null&&typeof t=="object"&&"getBoundingClientRect"in t&&("contextElement"in t?t instanceof Element:!0)}var N=class extends C{constructor(){super(...arguments),this.localize=new G(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){let t=this.anchorEl.getBoundingClientRect(),e=this.popup.getBoundingClientRect(),o=this.placement.includes("top")||this.placement.includes("bottom"),i=0,s=0,r=0,l=0,c=0,n=0,b=0,g=0;o?t.top<e.top?(i=t.left,s=t.bottom,r=t.right,l=t.bottom,c=e.left,n=e.top,b=e.right,g=e.top):(i=e.left,s=e.bottom,r=e.right,l=e.bottom,c=t.left,n=t.top,b=t.right,g=t.top):t.left<e.left?(i=t.right,s=t.top,r=e.left,l=e.top,c=t.right,n=t.bottom,b=e.left,g=e.bottom):(i=e.right,s=e.top,r=t.left,l=t.top,c=e.right,n=e.bottom,b=t.left,g=t.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${i}px`),this.style.setProperty("--hover-bridge-top-left-y",`${s}px`),this.style.setProperty("--hover-bridge-top-right-x",`${r}px`),this.style.setProperty("--hover-bridge-top-right-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${c}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${n}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${b}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${g}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(t){super.updated(t),t.has("active")&&(this.active?this.start():this.stop()),t.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){let t=this.getRootNode();this.anchorEl=t.getElementById(this.anchor)}else this.anchor instanceof Element||Kr(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){this.anchorEl&&(this.cleanup=Fs(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(t=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>t())):t()})}reposition(){if(!this.active||!this.anchorEl)return;let t=[ys({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?t.push(Go({apply:({rects:o})=>{let i=this.sync==="width"||this.sync==="both",s=this.sync==="height"||this.sync==="both";this.popup.style.width=i?`${o.reference.width}px`:"",this.popup.style.height=s?`${o.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&t.push(Cs({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&t.push(Is({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?t.push(Go({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:o,availableHeight:i})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${i}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${o}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&t.push(fs({element:this.arrowEl,padding:this.arrowPadding}));let e=this.strategy==="absolute"?o=>fe.getOffsetParent(o,vs):fe.getOffsetParent;Ls(this.anchorEl,this.popup,{placement:this.placement,middleware:t,strategy:this.strategy,platform:Nt(H({},fe),{getOffsetParent:e})}).then(({x:o,y:i,middlewareData:s,placement:r})=>{let l=this.localize.dir()==="rtl",c={top:"bottom",right:"left",bottom:"top",left:"right"}[r.split("-")[0]];if(this.setAttribute("data-current-placement",r),Object.assign(this.popup.style,{left:`${o}px`,top:`${i}px`}),this.arrow){let n=s.arrow.x,b=s.arrow.y,g="",u="",p="",h="";if(this.arrowPlacement==="start"){let Q=typeof n=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";g=typeof b=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",u=l?Q:"",h=l?"":Q}else if(this.arrowPlacement==="end"){let Q=typeof n=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";u=l?"":Q,h=l?Q:"",p=typeof b=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(h=typeof n=="number"?"calc(50% - var(--arrow-size-diagonal))":"",g=typeof b=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(h=typeof n=="number"?`${n}px`:"",g=typeof b=="number"?`${b}px`:"");Object.assign(this.arrowEl.style,{top:g,right:u,bottom:p,left:h,[c]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("sl-reposition")}render(){return m`
...
`;var so=class extends C{connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu")}handleClick(t){let e=["menuitem","menuitemcheckbox"],o=t.composedPath(),i=o.find(c=>{var n;return e.includes(((n=c?.getAttribute)==null?void 0:n.call(c,"role"))||"")});if(!i||o.find(c=>{var n;return((n=c?.getAttribute)==null?void 0:n.call(c,"role"))==="menu"})!==this)return;let l=i;l.type==="checkbox"&&(l.checked=!l.checked),this.emit("sl-select",{detail:{item:l}})}handleKeyDown(t){if(t.key==="Enter"||t.key===" "){let e=this.getCurrentItem();t.preventDefault(),t.stopPropagation(),e?.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(t.key)){let e=this.getAllItems(),o=this.getCurrentItem(),i=o?e.indexOf(o):0;e.length>0&&(t.preventDefault(),t.stopPropagation(),t.key==="ArrowDown"?i++:t.key==="ArrowUp"?i--:t.key==="Home"?i=0:t.key==="End"&&(i=e.length-1),i<0&&(i=e.length-1),i>e.length-1&&(i=0),this.setCurrentItem(e[i]),e[i].focus())}}handleMouseDown(t){let e=t.target;this.isMenuItem(e)&&this.setCurrentItem(e)}handleSlotChange(){let t=this.getAllItems();t.length>0&&this.setCurrentItem(t[0])}isMenuItem(t){var e;return t.tagName.toLowerCase()==="sl-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((e=t.getAttribute("role"))!=null?e:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(t=>!(t.inert||!this.isMenuItem(t)))}getCurrentItem(){return this.getAllItems().find(t=>t.getAttribute("tabindex")==="0")}setCurrentItem(t){this.getAllItems().forEach(o=>{o.setAttribute("tabindex",o===t?"0":"-1")})}render(){return m`
      ...
      ></slot>
    `}};so.styles=[L,Os];a([x("slot")],so.prototype,"defaultSlot",2);so.define("sl-menu");var Ws=y`
  :host {
    --submenu-offset: -2px;
...
`;var Wt=class extends C{constructor(){super(...arguments),this.localize=new G(this),this.variant="neutral",this.size="medium",this.pill=!1,this.removable=!1}handleRemoveClick(){this.emit("sl-remove")}render(){return m`
      <span
        part="base"
...
lit-html/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=/_bridgetown/static/index.R27R6WGD.js.map
