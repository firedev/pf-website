...
`;var V=class{constructor(t,...e){this.slotNames=[],this.handleSlotChange=o=>{let r=o.target;(this.slotNames.includes("[default]")&&!r.name||r.name&&this.slotNames.includes(r.name))&&this.host.requestUpdate()},(this.host=t).addController(this),this.slotNames=e}hasDefaultSlot(){return[...this.host.childNodes].some(t=>{if(t.nodeType===t.TEXT_NODE&&t.textContent.trim()!=="")return!0;if(t.nodeType===t.ELEMENT_NODE){let e=t;if(e.tagName.toLowerCase()==="sl-visually-hidden")return!1;if(!e.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(t){return this.host.querySelector(`:scope > [slot="${t}"]`)!==null}test(t){return t==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(t)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}};function Ir(t){if(!t)return"";let e=t.assignedNodes({flatten:!0}),o="";return[...e].forEach(r=>{r.nodeType===Node.TEXT_NODE&&(o+=r.textContent)}),o}var yo="";function pe(t){yo=t}function Io(t=""){if(!yo){let e=[...document.getElementsByTagName("script")],o=e.find(r=>r.hasAttribute("data-shoelace"));if(o)pe(o.getAttribute("data-shoelace"));else{let r=e.find(s=>/shoelace(\.min)?\.js($|\?)/.test(s.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(s.src)),i="";r&&(i=r.getAttribute("src")),pe(i.split("/").slice(0,-1).join("/"))}}return yo.replace(/\/$/,"")+(t?`/${t.replace(/^\//,"")}`:"")}var Qs={name:"default",resolver:t=>Io(`assets/icons/${t}.svg`)},fr=Qs;var vr={caret:`
  ...
  `},Bs={name:"system",resolver:t=>t in vr?`data:image/svg+xml,${encodeURIComponent(vr[t])}`:""},wr=Bs;var je=[fr,wr],Ve=[];function Lr(t){Ve.push(t)}function xr(t){Ve=Ve.filter(e=>e!==t)}function fo(t){return je.find(e=>e.name===t)}function Ye(t,e){Ar(t),je.push({name:t,resolver:e.resolver,mutator:e.mutator,spriteSheet:e.spriteSheet}),Ve.forEach(o=>{o.library===t&&o.setIcon()})}function Ar(t){je=je.filter(e=>e.name!==t)}var Nr=C`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
...
`;var T=class extends I{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){let t=!!this.href,e=t?$t`a`:$t`button`;return qt`
    ...
    `}};T.styles=[v,Sr];T.dependencies={"sl-icon":k};a([L(".icon-button")],T.prototype,"button",2);a([S()],T.prototype,"hasFocus",2);a([d()],T.prototype,"name",2);a([d()],T.prototype,"library",2);a([d()],T.prototype,"src",2);a([d()],T.prototype,"href",2);a([d()],T.prototype,"target",2);a([d()],T.prototype,"download",2);a([d()],T.prototype,"label",2);a([d({type:Boolean,reflect:!0})],T.prototype,"disabled",2);var jr=new Map,Is=new WeakMap;function fs(t){return t??{keyframes:[],options:{duration:0}}}function Rr(t,e){return e.toLowerCase()==="rtl"?{keyframes:t.rtlKeyframes||t.keyframes,options:t.options}:t}function P(t,e){jr.set(t,fs(e))}function K(t,e,o){let r=Is.get(t);if(r?.[e])return Rr(r[e],o.dir);let i=jr.get(e);return i?Rr(i,o.dir):{keyframes:[],options:{duration:0}}}function Bt(t,e){return new Promise(o=>{function r(i){i.target===t&&(t.removeEventListener(e,r),o())}t.addEventListener(e,r)})}function $(t,e,o){return new Promise(r=>{if(o?.duration===1/0)throw new Error("Promise-based animations must be finite.");let i=t.animate(e,At(H({},o),{duration:vs()?0:o.duration}));i.addEventListener("cancel",r,{once:!0}),i.addEventListener("finish",r,{once:!0})})}function vs(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function it(t){return Promise.all(t.getAnimations().map(e=>new Promise(o=>{e.cancel(),requestAnimationFrame(o)})))}var Vr=C`
  :host {
    display: contents;
...
`;var te=Object.assign(document.createElement("div"),{className:"sl-toast-stack"}),Y=class extends I{constructor(){super(...arguments),this.hasSlotController=new V(this,"icon","suffix"),this.localize=new G(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){var t;(t=this.countdownAnimation)==null||t.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){var t;this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),(t=this.countdownAnimation)==null||t.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){let{countdownElement:t}=this,e="100%",o="0";this.countdownAnimation=t.animate([{width:e},{width:o}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.duration<1/0&&this.restartAutoHide(),await it(this.base),this.base.hidden=!1;let{keyframes:t,options:e}=K(this,"alert.show",{dir:this.localize.dir()});await $(this.base,t,e),this.emit("sl-after-show")}else{this.emit("sl-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await it(this.base);let{keyframes:t,options:e}=K(this,"alert.hide",{dir:this.localize.dir()});await $(this.base,t,e),this.base.hidden=!0,this.emit("sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,Bt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,Bt(this,"sl-after-hide")}async toast(){return new Promise(t=>{this.handleCountdownChange(),te.parentElement===null&&document.body.append(te),te.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("sl-after-hide",()=>{te.removeChild(this),t(),te.querySelector("sl-alert")===null&&te.remove()},{once:!0})})}render(){return Q`
    ...
    `}};Y.styles=[v,Vr];Y.dependencies={"sl-icon-button":T};a([L('[part~="base"]')],Y.prototype,"base",2);a([L(".alert__countdown-elapsed")],Y.prototype,"countdownElement",2);a([d({type:Boolean,reflect:!0})],Y.prototype,"open",2);a([d({type:Boolean,reflect:!0})],Y.prototype,"closable",2);a([d({reflect:!0})],Y.prototype,"variant",2);a([d({type:Number})],Y.prototype,"duration",2);a([d({type:String,reflect:!0})],Y.prototype,"countdown",2);a([S()],Y.prototype,"remainingTime",2);a([O("open",{waitUntilFirstUpdate:!0})],Y.prototype,"handleOpenChange",1);a([O("duration")],Y.prototype,"handleDurationChange",1);P("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});P("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});Y.define("sl-alert");var Yr=C`
  :host {
    display: inline-block;
...
`;var st=class extends I{constructor(){super(...arguments),this.hasError=!1,this.image="",this.label="",this.initials="",this.loading="eager",this.shape="circle"}handleImageChange(){this.hasError=!1}handleImageLoadError(){this.hasError=!0,this.emit("sl-error")}render(){let t=Q`
    ...
    `}};st.styles=[v,Yr];st.dependencies={"sl-icon":k};a([S()],st.prototype,"hasError",2);a([d()],st.prototype,"image",2);a([d()],st.prototype,"label",2);a([d()],st.prototype,"initials",2);a([d()],st.prototype,"loading",2);a([d({reflect:!0})],st.prototype,"shape",2);a([O("image")],st.prototype,"handleImageChange",1);st.define("sl-avatar");var Er=C`
  .breadcrumb {
    display: flex;
    align-items: center;
    flex-wrap: wrap;
  }
`;var Rt=class extends I{constructor(){super(...arguments),this.localize=new G(this),this.separatorDir=this.localize.dir(),this.label=""}getSeparator(){let e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll("[id]")].forEach(o=>o.removeAttribute("id")),e.setAttribute("data-default",""),e.slot="separator",e}handleSlotChange(){let t=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()==="sl-breadcrumb-item");t.forEach((e,o)=>{let r=e.querySelector('[slot="separator"]');r===null?e.append(this.getSeparator()):r.hasAttribute("data-default")&&r.replaceWith(this.getSeparator()),o===t.length-1?e.setAttribute("aria-current","page"):e.removeAttribute("aria-current")})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),Q`
    ...
    `}};Rt.styles=[v,Er];Rt.dependencies={"sl-icon":k};a([L("slot")],Rt.prototype,"defaultSlot",2);a([L('slot[name="separator"]')],Rt.prototype,"separatorSlot",2);a([d()],Rt.prototype,"label",2);Rt.define("sl-breadcrumb");var Jr=C`
  :host {
    display: inline-flex;
  }
...
`;var Ft=class extends I{constructor(){super(...arguments),this.hasSlotController=new V(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}setRenderType(){let t=this.defaultSlot.assignedElements({flatten:!0}).filter(e=>e.tagName.toLowerCase()==="sl-dropdown").length>0;if(this.href){this.renderType="link";return}if(t){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return Q`
    ...
    `}};Ft.styles=[v,Jr];a([L("slot:not([name])")],Ft.prototype,"defaultSlot",2);a([S()],Ft.prototype,"renderType",2);a([d()],Ft.prototype,"href",2);a([d()],Ft.prototype,"target",2);a([d()],Ft.prototype,"rel",2);a([O("href",{waitUntilFirstUpdate:!0})],Ft.prototype,"hrefChanged",1);Ft.define("sl-breadcrumb-item");var Hr=C`
  :host {
...
`;var xo=class extends I{constructor(){super(...arguments),this.hasSlotController=new V(this,"footer","header","image")}render(){return Q`
      <div
        part="base"
...
`;var lt=class extends I{constructor(){super(...arguments),this.hasSlotController=new V(this,"footer"),this.localize=new G(this),this.modal=new $r(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=t=>{t.key==="Escape"&&this.modal.isActive()&&this.open&&(t.stopPropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),Wo(this))}disconnectedCallback(){var t;super.disconnectedCallback(),this.modal.deactivate(),Oo(this),(t=this.closeWatcher)==null||t.destroy()}requestClose(t){if(this.emit("sl-request-close",{cancelable:!0,detail:{source:t}}).defaultPrevented){let o=K(this,"dialog.denyClose",{dir:this.localize.dir()});$(this.panel,o.keyframes,o.options);return}this.hide()}addOpenListeners(){var t;"CloseWatcher"in window?((t=this.closeWatcher)==null||t.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){var t;(t=this.closeWatcher)==null||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),Wo(this);let t=this.querySelector("[autofocus]");t&&t.removeAttribute("autofocus"),await Promise.all([it(this.dialog),it(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("sl-initial-focus",{cancelable:!0}).defaultPrevented||(t?t.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),t&&t.setAttribute("autofocus","")});let e=K(this,"dialog.show",{dir:this.localize.dir()}),o=K(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([$(this.panel,e.keyframes,e.options),$(this.overlay,o.keyframes,o.options)]),this.emit("sl-after-show")}else{this.emit("sl-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([it(this.dialog),it(this.overlay)]);let t=K(this,"dialog.hide",{dir:this.localize.dir()}),e=K(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([$(this.overlay,e.keyframes,e.options).then(()=>{this.overlay.hidden=!0}),$(this.panel,t.keyframes,t.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,Oo(this);let o=this.originalTrigger;typeof o?.focus=="function"&&setTimeout(()=>o.focus()),this.emit("sl-after-hide")}}async show(){if(!this.open)return this.open=!0,Bt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,Bt(this,"sl-after-hide")}render(){return Q`
    ...
    `}};lt.styles=[v,qr];lt.dependencies={"sl-icon-button":T};a([L(".dialog")],lt.prototype,"dialog",2);a([L(".dialog__panel")],lt.prototype,"panel",2);a([L(".dialog__overlay")],lt.prototype,"overlay",2);a([d({type:Boolean,reflect:!0})],lt.prototype,"open",2);a([d({reflect:!0})],lt.prototype,"label",2);a([d({attribute:"no-header",type:Boolean,reflect:!0})],lt.prototype,"noHeader",2);a([O("open",{waitUntilFirstUpdate:!0})],lt.prototype,"handleOpenChange",1);P("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});P("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});P("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}});P("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});P("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});lt.define("sl-dialog");var ti=C`
  :host {
...
`;var ht=Math.min,R=Math.max,Ce=Math.round,ye=Math.floor,at=t=>({x:t,y:t}),Ds={left:"right",right:"left",bottom:"top",top:"bottom"},Ms={start:"end",end:"start"};function $e(t,e,o){return R(t,ht(e,o))}function jt(t,e){return typeof t=="function"?t(e):t}function Ut(t){return t.split("-")[0]}function Vt(t){return t.split("-")[1]}function Do(t){return t==="x"?"y":"x"}function qe(t){return t==="y"?"height":"width"}function Wt(t){return["top","bottom"].includes(Ut(t))?"y":"x"}function to(t){return Do(Wt(t))}function ri(t,e,o){o===void 0&&(o=!1);let r=Vt(t),i=to(t),s=qe(i),l=i==="x"?r===(o?"end":"start")?"right":"left":r==="start"?"bottom":"top";return e.reference[s]>e.floating[s]&&(l=Ue(l)),[l,Ue(l)]}function ii(t){let e=Ue(t);return[Ke(t),e,Ke(e)]}function Ke(t){return t.replace(/start|end/g,e=>Ms[e])}function ks(t,e,o){let r=["left","right"],i=["right","left"],s=["top","bottom"],l=["bottom","top"];switch(t){case"top":case"bottom":return o?e?i:r:e?r:i;case"left":case"right":return e?s:l;default:return[]}}function si(t,e,o,r){let i=Vt(t),s=ks(Ut(t),o==="start",r);return i&&(s=s.map(l=>l+"-"+i),e&&(s=s.concat(s.map(Ke)))),s}function Ue(t){return t.replace(/left|right|bottom|top/g,e=>Ds[e])}function Gs(t){return{top:0,right:0,bottom:0,left:0,...t}}function Mo(t){return typeof t!="number"?Gs(t):{top:t,right:t,bottom:t,left:t}}function Yt(t){let{x:e,y:o,width:r,height:i}=t;return{width:r,height:i,top:o,left:e,right:e+r,bottom:o+i,x:e,y:o}}function li(t,e,o){let{reference:r,floating:i}=t,s=Wt(e),l=to(e),c=qe(l),n=Ut(e),b=s==="y",h=r.x+r.width/2-i.width/2,u=r.y+r.height/2-i.height/2,p=r[c]/2-i[c]/2,g;switch(n){case"top":g={x:h,y:r.y-i.height};break;case"bottom":g={x:h,y:r.y+r.height};break;case"right":g={x:r.x+r.width,y:u};break;case"left":g={x:r.x-i.width,y:u};break;default:g={x:r.x,y:r.y}}switch(Vt(e)){case"start":g[l]-=p*(o&&b?-1:1);break;case"end":g[l]+=p*(o&&b?-1:1);break}return g}var ai=async(t,e,o)=>{let{placement:r="bottom",strategy:i="absolute",middleware:s=[],platform:l}=o,c=s.filter(Boolean),n=await(l.isRTL==null?void 0:l.isRTL(e)),b=await l.getElementRects({reference:t,floating:e,strategy:i}),{x:h,y:u}=li(b,r,n),p=r,g={},m=0;for(let U=0;U<c.length;U++){let{name:f,fn:y}=c[U],{x:w,y:W,data:X,reset:M}=await y({x:h,y:u,initialPlacement:r,placement:p,strategy:i,middlewareData:g,rects:b,platform:l,elements:{reference:t,floating:e}});h=w??h,u=W??u,g={...g,[f]:{...g[f],...X}},M&&m<=50&&(m++,typeof M=="object"&&(M.placement&&(p=M.placement),M.rects&&(b=M.rects===!0?await l.getElementRects({reference:t,floating:e,strategy:i}):M.rects),{x:h,y:u}=li(b,p,n)),U=-1)}return{x:h,y:u,placement:p,strategy:i,middlewareData:g}};async function eo(t,e){var o;e===void 0&&(e={});let{x:r,y:i,platform:s,rects:l,elements:c,strategy:n}=t,{boundary:b="clippingAncestors",rootBoundary:h="viewport",elementContext:u="floating",altBoundary:p=!1,padding:g=0}=jt(e,t),m=Mo(g),f=c[p?u==="floating"?"reference":"floating":u],y=Yt(await s.getClippingRect({element:(o=await(s.isElement==null?void 0:s.isElement(f)))==null||o?f:f.contextElement||await(s.getDocumentElement==null?void 0:s.getDocumentElement(c.floating)),boundary:b,rootBoundary:h,strategy:n})),w=u==="floating"?{x:r,y:i,width:l.floating.width,height:l.floating.height}:l.reference,W=await(s.getOffsetParent==null?void 0:s.getOffsetParent(c.floating)),X=await(s.isElement==null?void 0:s.isElement(W))?await(s.getScale==null?void 0:s.getScale(W))||{x:1,y:1}:{x:1,y:1},M=Yt(s.convertOffsetParentRelativeRectToViewportRelativeRect?await s.convertOffsetParentRelativeRectToViewportRelativeRect({elements:c,rect:w,offsetParent:W,strategy:n}):w);return{top:(y.top-M.top+m.top)/X.y,bottom:(M.bottom-y.bottom+m.bottom)/X.y,left:(y.left-M.left+m.left)/X.x,right:(M.right-y.right+m.right)/X.x}}var ni=t=>({name:"arrow",options:t,async fn(e){let{x:o,y:r,placement:i,rects:s,platform:l,elements:c,middlewareData:n}=e,{element:b,padding:h=0}=jt(t,e)||{};if(b==null)return{};let u=Mo(h),p={x:o,y:r},g=to(i),m=qe(g),U=await l.getDimensions(b),f=g==="y",y=f?"top":"left",w=f?"bottom":"right",W=f?"clientHeight":"clientWidth",X=s.reference[m]+s.reference[g]-p[g]-s.floating[m],M=p[g]-s.reference[g],_=await(l.getOffsetParent==null?void 0:l.getOffsetParent(b)),et=_?_[W]:0;(!et||!await(l.isElement==null?void 0:l.isElement(_)))&&(et=c.floating[W]||s.floating[m]);let gt=X/2-M/2,dt=et/2-U[m]/2-1,ot=ht(u[y],dt),yt=ht(u[w],dt),bt=ot,It=et-U[m]-yt,Z=et/2-U[m]/2+gt,_t=$e(bt,Z,It),pt=!n.arrow&&Vt(i)!=null&&Z!==_t&&s.reference[m]/2-(Z<bt?ot:yt)-U[m]/2<0,ut=pt?Z<bt?Z-bt:Z-It:0;return{[g]:p[g]+ut,data:{[g]:_t,centerOffset:Z-_t-ut,...pt&&{alignmentOffset:ut}},reset:pt}}});var ci=function(t){return t===void 0&&(t={}),{name:"flip",options:t,async fn(e){var o,r;let{placement:i,middlewareData:s,rects:l,initialPlacement:c,platform:n,elements:b}=e,{mainAxis:h=!0,crossAxis:u=!0,fallbackPlacements:p,fallbackStrategy:g="bestFit",fallbackAxisSideDirection:m="none",flipAlignment:U=!0,...f}=jt(t,e);if((o=s.arrow)!=null&&o.alignmentOffset)return{};let y=Ut(i),w=Wt(c),W=Ut(c)===c,X=await(n.isRTL==null?void 0:n.isRTL(b.floating)),M=p||(W||!U?[Ue(c)]:ii(c)),_=m!=="none";!p&&_&&M.push(...si(c,U,m,X));let et=[c,...M],gt=await eo(e,f),dt=[],ot=((r=s.flip)==null?void 0:r.overflows)||[];if(h&&dt.push(gt[y]),u){let Z=ri(i,l,X);dt.push(gt[Z[0]],gt[Z[1]])}if(ot=[...ot,{placement:i,overflows:dt}],!dt.every(Z=>Z<=0)){var yt,bt;let Z=(((yt=s.flip)==null?void 0:yt.index)||0)+1,_t=et[Z];if(_t)return{data:{index:Z,overflows:ot},reset:{placement:_t}};let pt=(bt=ot.filter(ut=>ut.overflows[0]<=0).sort((ut,ft)=>ut.overflows[1]-ft.overflows[1])[0])==null?void 0:bt.placement;if(!pt)switch(g){case"bestFit":{var It;let ut=(It=ot.filter(ft=>{if(_){let vt=Wt(ft.placement);return vt===w||vt==="y"}return!0}).map(ft=>[ft.placement,ft.overflows.filter(vt=>vt>0).reduce((vt,Yi)=>vt+Yi,0)]).sort((ft,vt)=>ft[1]-vt[1])[0])==null?void 0:It[0];ut&&(pt=ut);break}case"initialPlacement":pt=c;break}if(i!==pt)return{reset:{placement:pt}}}return{}}}};async function Xs(t,e){let{placement:o,platform:r,elements:i}=t,s=await(r.isRTL==null?void 0:r.isRTL(i.floating)),l=Ut(o),c=Vt(o),n=Wt(o)==="y",b=["left","top"].includes(l)?-1:1,h=s&&n?-1:1,u=jt(e,t),{mainAxis:p,crossAxis:g,alignmentAxis:m}=typeof u=="number"?{mainAxis:u,crossAxis:0,alignmentAxis:null}:{mainAxis:u.mainAxis||0,crossAxis:u.crossAxis||0,alignmentAxis:u.alignmentAxis};return c&&typeof m=="number"&&(g=c==="end"?m*-1:m),n?{x:g*h,y:p*b}:{x:p*b,y:g*h}}var di=function(t){return t===void 0&&(t=0),{name:"offset",options:t,async fn(e){var o,r;let{x:i,y:s,placement:l,middlewareData:c}=e,n=await Xs(e,t);return l===((o=c.offset)==null?void 0:o.placement)&&(r=c.arrow)!=null&&r.alignmentOffset?{}:{x:i+n.x,y:s+n.y,data:{...n,placement:l}}}}},bi=function(t){return t===void 0&&(t={}),{name:"shift",options:t,async fn(e){let{x:o,y:r,placement:i}=e,{mainAxis:s=!0,crossAxis:l=!1,limiter:c={fn:f=>{let{x:y,y:w}=f;return{x:y,y:w}}},...n}=jt(t,e),b={x:o,y:r},h=await eo(e,n),u=Wt(Ut(i)),p=Do(u),g=b[p],m=b[u];if(s){let f=p==="y"?"top":"left",y=p==="y"?"bottom":"right",w=g+h[f],W=g-h[y];g=$e(w,g,W)}if(l){let f=u==="y"?"top":"left",y=u==="y"?"bottom":"right",w=m+h[f],W=m-h[y];m=$e(w,m,W)}let U=c.fn({...e,[p]:g,[u]:m});return{...U,data:{x:U.x-o,y:U.y-r,enabled:{[p]:s,[u]:l}}}}}};var ui=function(t){return t===void 0&&(t={}),{name:"size",options:t,async fn(e){var o,r;let{placement:i,rects:s,platform:l,elements:c}=e,{apply:n=()=>{},...b}=jt(t,e),h=await eo(e,b),u=Ut(i),p=Vt(i),g=Wt(i)==="y",{width:m,height:U}=s.floating,f,y;u==="top"||u==="bottom"?(f=u,y=p===(await(l.isRTL==null?void 0:l.isRTL(c.floating))?"start":"end")?"left":"right"):(y=u,f=p==="end"?"top":"bottom");let w=U-h.top-h.bottom,W=m-h.left-h.right,X=ht(U-h[f],w),M=ht(m-h[y],W),_=!e.middlewareData.shift,et=X,gt=M;if((o=e.middlewareData.shift)!=null&&o.enabled.x&&(gt=W),(r=e.middlewareData.shift)!=null&&r.enabled.y&&(et=w),_&&!p){let ot=R(h.left,0),yt=R(h.right,0),bt=R(h.top,0),It=R(h.bottom,0);g?gt=m-2*(ot!==0||yt!==0?ot+yt:R(h.left,h.right)):et=U-2*(bt!==0||It!==0?bt+It:R(h.top,h.bottom))}await n({...e,availableWidth:gt,availableHeight:et});let dt=await l.getDimensions(c.floating);return m!==dt.width||U!==dt.height?{reset:{rects:!0}}:{}}}};function oo(){return typeof window<"u"}function Et(t){return gi(t)?(t.nodeName||"").toLowerCase():"#document"}function E(t){var e;return(t==null||(e=t.ownerDocument)==null?void 0:e.defaultView)||window}function nt(t){var e;return(e=(gi(t)?t.ownerDocument:t.document)||window.document)==null?void 0:e.documentElement}function gi(t){return oo()?t instanceof Node||t instanceof E(t).Node:!1}function q(t){return oo()?t instanceof Element||t instanceof E(t).Element:!1}function ct(t){return oo()?t instanceof HTMLElement||t instanceof E(t).HTMLElement:!1}function hi(t){return!oo()||typeof ShadowRoot>"u"?!1:t instanceof ShadowRoot||t instanceof E(t).ShadowRoot}function oe(t){let{overflow:e,overflowX:o,overflowY:r,display:i}=tt(t);return/auto|scroll|overlay|hidden|clip/.test(e+r+o)&&!["inline","contents"].includes(i)}function pi(t){return["table","td","th"].includes(Et(t))}function Ie(t){return[":popover-open",":modal"].some(e=>{try{return t.matches(e)}catch{return!1}})}function ro(t){let e=io(),o=q(t)?tt(t):t;return o.transform!=="none"||o.perspective!=="none"||(o.containerType?o.containerType!=="normal":!1)||!e&&(o.backdropFilter?o.backdropFilter!=="none":!1)||!e&&(o.filter?o.filter!=="none":!1)||["transform","perspective","filter"].some(r=>(o.willChange||"").includes(r))||["paint","layout","strict","content"].some(r=>(o.contain||"").includes(r))}function mi(t){let e=Ct(t);for(;ct(e)&&!Jt(e);){if(ro(e))return e;if(Ie(e))return null;e=Ct(e)}return null}function io(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}function Jt(t){return["html","body","#document"].includes(Et(t))}function tt(t){return E(t).getComputedStyle(t)}function fe(t){return q(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.scrollX,scrollTop:t.scrollY}}function Ct(t){if(Et(t)==="html")return t;let e=t.assignedSlot||t.parentNode||hi(t)&&t.host||nt(t);return hi(e)?e.host:e}function Qi(t){let e=Ct(t);return Jt(e)?t.ownerDocument?t.ownerDocument.body:t.body:ct(e)&&oe(e)?e:Qi(e)}function ee(t,e,o){var r;e===void 0&&(e=[]),o===void 0&&(o=!0);let i=Qi(t),s=i===((r=t.ownerDocument)==null?void 0:r.body),l=E(i);if(s){let c=so(l);return e.concat(l,l.visualViewport||[],oe(i)?i:[],c&&o?ee(c):[])}return e.concat(i,ee(i,[],o))}function so(t){return t.parent&&Object.getPrototypeOf(t.parent)?t.frameElement:null}function Ui(t){let e=tt(t),o=parseFloat(e.width)||0,r=parseFloat(e.height)||0,i=ct(t),s=i?t.offsetWidth:o,l=i?t.offsetHeight:r,c=Ce(o)!==s||Ce(r)!==l;return c&&(o=s,r=l),{width:o,height:r,$:c}}function Go(t){return q(t)?t:t.contextElement}function re(t){let e=Go(t);if(!ct(e))return at(1);let o=e.getBoundingClientRect(),{width:r,height:i,$:s}=Ui(e),l=(s?Ce(o.width):o.width)/r,c=(s?Ce(o.height):o.height)/i;return(!l||!Number.isFinite(l))&&(l=1),(!c||!Number.isFinite(c))&&(c=1),{x:l,y:c}}var Ts=at(0);function Ci(t){let e=E(t);return!io()||!e.visualViewport?Ts:{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}}function zs(t,e,o){return e===void 0&&(e=!1),!o||e&&o!==E(t)?!1:e}function Ht(t,e,o,r){e===void 0&&(e=!1),o===void 0&&(o=!1);let i=t.getBoundingClientRect(),s=Go(t),l=at(1);e&&(r?q(r)&&(l=re(r)):l=re(t));let c=zs(s,o,r)?Ci(s):at(0),n=(i.left+c.x)/l.x,b=(i.top+c.y)/l.y,h=i.width/l.x,u=i.height/l.y;if(s){let p=E(s),g=r&&q(r)?E(r):r,m=p,U=so(m);for(;U&&r&&g!==m;){let f=re(U),y=U.getBoundingClientRect(),w=tt(U),W=y.left+(U.clientLeft+parseFloat(w.paddingLeft))*f.x,X=y.top+(U.clientTop+parseFloat(w.paddingTop))*f.y;n*=f.x,b*=f.y,h*=f.x,u*=f.y,n+=W,b+=X,m=E(U),U=so(m)}}return Yt({width:h,height:u,x:n,y:b})}function Xo(t,e){let o=fe(t).scrollLeft;return e?e.left+o:Ht(nt(t)).left+o}function yi(t,e,o){o===void 0&&(o=!1);let r=t.getBoundingClientRect(),i=r.left+e.scrollLeft-(o?0:Xo(t,r)),s=r.top+e.scrollTop;return{x:i,y:s}}function Zs(t){let{elements:e,rect:o,offsetParent:r,strategy:i}=t,s=i==="fixed",l=nt(r),c=e?Ie(e.floating):!1;if(r===l||c&&s)return o;let n={scrollLeft:0,scrollTop:0},b=at(1),h=at(0),u=ct(r);if((u||!u&&!s)&&((Et(r)!=="body"||oe(l))&&(n=fe(r)),ct(r))){let g=Ht(r);b=re(r),h.x=g.x+r.clientLeft,h.y=g.y+r.clientTop}let p=l&&!u&&!s?yi(l,n,!0):at(0);return{width:o.width*b.x,height:o.height*b.y,x:o.x*b.x-n.scrollLeft*b.x+h.x+p.x,y:o.y*b.y-n.scrollTop*b.y+h.y+p.y}}function Ss(t){return Array.from(t.getClientRects())}function Rs(t){let e=nt(t),o=fe(t),r=t.ownerDocument.body,i=R(e.scrollWidth,e.clientWidth,r.scrollWidth,r.clientWidth),s=R(e.scrollHeight,e.clientHeight,r.scrollHeight,r.clientHeight),l=-o.scrollLeft+Xo(t),c=-o.scrollTop;return tt(r).direction==="rtl"&&(l+=R(e.clientWidth,r.clientWidth)-i),{width:i,height:s,x:l,y:c}}function js(t,e){let o=E(t),r=nt(t),i=o.visualViewport,s=r.clientWidth,l=r.clientHeight,c=0,n=0;if(i){s=i.width,l=i.height;let b=io();(!b||b&&e==="fixed")&&(c=i.offsetLeft,n=i.offsetTop)}return{width:s,height:l,x:c,y:n}}function Vs(t,e){let o=Ht(t,!0,e==="fixed"),r=o.top+t.clientTop,i=o.left+t.clientLeft,s=ct(t)?re(t):at(1),l=t.clientWidth*s.x,c=t.clientHeight*s.y,n=i*s.x,b=r*s.y;return{width:l,height:c,x:n,y:b}}function Bi(t,e,o){let r;if(e==="viewport")r=js(t,o);else if(e==="document")r=Rs(nt(t));else if(q(e))r=Vs(e,o);else{let i=Ci(t);r={x:e.x-i.x,y:e.y-i.y,width:e.width,height:e.height}}return Yt(r)}function Ii(t,e){let o=Ct(t);return o===e||!q(o)||Jt(o)?!1:tt(o).position==="fixed"||Ii(o,e)}function Ys(t,e){let o=e.get(t);if(o)return o;let r=ee(t,[],!1).filter(c=>q(c)&&Et(c)!=="body"),i=null,s=tt(t).position==="fixed",l=s?Ct(t):t;for(;q(l)&&!Jt(l);){let c=tt(l),n=ro(l);!n&&c.position==="fixed"&&(i=null),(s?!n&&!i:!n&&c.position==="static"&&!!i&&["absolute","fixed"].includes(i.position)||oe(l)&&!n&&Ii(t,l))?r=r.filter(h=>h!==l):i=c,l=Ct(l)}return e.set(t,r),r}function Es(t){let{element:e,boundary:o,rootBoundary:r,strategy:i}=t,l=[...o==="clippingAncestors"?Ie(e)?[]:Ys(e,this._c):[].concat(o),r],c=l[0],n=l.reduce((b,h)=>{let u=Bi(e,h,i);return b.top=R(u.top,b.top),b.right=ht(u.right,b.right),b.bottom=ht(u.bottom,b.bottom),b.left=R(u.left,b.left),b},Bi(e,c,i));return{width:n.right-n.left,height:n.bottom-n.top,x:n.left,y:n.top}}function Js(t){let{width:e,height:o}=Ui(t);return{width:e,height:o}}function Hs(t,e,o){let r=ct(e),i=nt(e),s=o==="fixed",l=Ht(t,!0,s,e),c={scrollLeft:0,scrollTop:0},n=at(0);if(r||!r&&!s)if((Et(e)!=="body"||oe(i))&&(c=fe(e)),r){let p=Ht(e,!0,s,e);n.x=p.x+e.clientLeft,n.y=p.y+e.clientTop}else i&&(n.x=Xo(i));let b=i&&!r&&!s?yi(i,c):at(0),h=l.left+c.scrollLeft-n.x-b.x,u=l.top+c.scrollTop-n.y-b.y;return{x:h,y:u,width:l.width,height:l.height}}function ko(t){return tt(t).position==="static"}function Fi(t,e){if(!ct(t)||tt(t).position==="fixed")return null;if(e)return e(t);let o=t.offsetParent;return nt(t)===o&&(o=o.ownerDocument.body),o}function fi(t,e){let o=E(t);if(Ie(t))return o;if(!ct(t)){let i=Ct(t);for(;i&&!Jt(i);){if(q(i)&&!ko(i))return i;i=Ct(i)}return o}let r=Fi(t,e);for(;r&&pi(r)&&ko(r);)r=Fi(r,e);return r&&Jt(r)&&ko(r)&&!ro(r)?o:r||mi(t)||o}var _s=async function(t){let e=this.getOffsetParent||fi,o=this.getDimensions,r=await o(t.floating);return{reference:Hs(t.reference,await e(t.floating),t.strategy),floating:{x:0,y:0,width:r.width,height:r.height}}};function Ps(t){return tt(t).direction==="rtl"}var ve={convertOffsetParentRelativeRectToViewportRelativeRect:Zs,getDocumentElement:nt,getClippingRect:Es,getOffsetParent:fi,getElementRects:_s,getClientRects:Ss,getDimensions:Js,getScale:re,isElement:q,isRTL:Ps};function Ks(t,e){let o=null,r,i=nt(t);function s(){var c;clearTimeout(r),(c=o)==null||c.disconnect(),o=null}function l(c,n){c===void 0&&(c=!1),n===void 0&&(n=1),s();let{left:b,top:h,width:u,height:p}=t.getBoundingClientRect();if(c||e(),!u||!p)return;let g=ye(h),m=ye(i.clientWidth-(b+u)),U=ye(i.clientHeight-(h+p)),f=ye(b),w={rootMargin:-g+"px "+-m+"px "+-U+"px "+-f+"px",threshold:R(0,ht(1,n))||1},W=!0;function X(M){let _=M[0].intersectionRatio;if(_!==n){if(!W)return l();_?l(!1,_):r=setTimeout(()=>{l(!1,1e-7)},1e3)}W=!1}try{o=new IntersectionObserver(X,{...w,root:i.ownerDocument})}catch{o=new IntersectionObserver(X,w)}o.observe(t)}return l(!0),s}function vi(t,e,o,r){r===void 0&&(r={});let{ancestorScroll:i=!0,ancestorResize:s=!0,elementResize:l=typeof ResizeObserver=="function",layoutShift:c=typeof IntersectionObserver=="function",animationFrame:n=!1}=r,b=Go(t),h=i||s?[...b?ee(b):[],...ee(e)]:[];h.forEach(y=>{i&&y.addEventListener("scroll",o,{passive:!0}),s&&y.addEventListener("resize",o)});let u=b&&c?Ks(b,o):null,p=-1,g=null;l&&(g=new ResizeObserver(y=>{let[w]=y;w&&w.target===b&&g&&(g.unobserve(e),cancelAnimationFrame(p),p=requestAnimationFrame(()=>{var W;(W=g)==null||W.observe(e)})),o()}),b&&!n&&g.observe(b),g.observe(e));let m,U=n?Ht(t):null;n&&f();function f(){let y=Ht(t);U&&(y.x!==U.x||y.y!==U.y||y.width!==U.width||y.height!==U.height)&&o(),U=y,m=requestAnimationFrame(f)}return o(),()=>{var y;h.forEach(w=>{i&&w.removeEventListener("scroll",o),s&&w.removeEventListener("resize",o)}),u?.(),(y=g)==null||y.disconnect(),g=null,n&&cancelAnimationFrame(m)}}var wi=di;var Li=bi,xi=ci,To=ui;var Ai=ni;var Ni=(t,e,o)=>{let r=new Map,i={platform:ve,...o},s={...i.platform,_c:r};return ai(t,e,{...i,platform:s})};function Wi(t){return $s(t)}function zo(t){return t.assignedSlot?t.assignedSlot:t.parentNode instanceof ShadowRoot?t.parentNode.host:t.parentNode}function $s(t){for(let e=t;e;e=zo(e))if(e instanceof Element&&getComputedStyle(e).display==="none")return null;for(let e=zo(t);e;e=zo(e)){if(!(e instanceof Element))continue;let o=getComputedStyle(e);if(o.display!=="contents"&&(o.position!=="static"||o.filter!=="none"||e.tagName==="BODY"))return e}return null}function qs(t){return t!==null&&typeof t=="object"&&"getBoundingClientRect"in t&&("contextElement"in t?t instanceof Element:!0)}var A=class extends I{constructor(){super(...arguments),this.localize=new G(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){let t=this.anchorEl.getBoundingClientRect(),e=this.popup.getBoundingClientRect(),o=this.placement.includes("top")||this.placement.includes("bottom"),r=0,i=0,s=0,l=0,c=0,n=0,b=0,h=0;o?t.top<e.top?(r=t.left,i=t.bottom,s=t.right,l=t.bottom,c=e.left,n=e.top,b=e.right,h=e.top):(r=e.left,i=e.bottom,s=e.right,l=e.bottom,c=t.left,n=t.top,b=t.right,h=t.top):t.left<e.left?(r=t.right,i=t.top,s=e.left,l=e.top,c=t.right,n=t.bottom,b=e.left,h=e.bottom):(r=e.right,i=e.top,s=t.left,l=t.top,c=e.right,n=e.bottom,b=t.left,h=t.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${r}px`),this.style.setProperty("--hover-bridge-top-left-y",`${i}px`),this.style.setProperty("--hover-bridge-top-right-x",`${s}px`),this.style.setProperty("--hover-bridge-top-right-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${c}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${n}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${b}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${h}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(t){super.updated(t),t.has("active")&&(this.active?this.start():this.stop()),t.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){let t=this.getRootNode();this.anchorEl=t.getElementById(this.anchor)}else this.anchor instanceof Element||qs(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){this.anchorEl&&(this.cleanup=vi(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(t=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>t())):t()})}reposition(){if(!this.active||!this.anchorEl)return;let t=[wi({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?t.push(To({apply:({rects:o})=>{let r=this.sync==="width"||this.sync==="both",i=this.sync==="height"||this.sync==="both";this.popup.style.width=r?`${o.reference.width}px`:"",this.popup.style.height=i?`${o.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&t.push(xi({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&t.push(Li({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?t.push(To({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:o,availableHeight:r})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${r}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${o}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&t.push(Ai({element:this.arrowEl,padding:this.arrowPadding}));let e=this.strategy==="absolute"?o=>ve.getOffsetParent(o,Wi):ve.getOffsetParent;Ni(this.anchorEl,this.popup,{placement:this.placement,middleware:t,strategy:this.strategy,platform:At(H({},ve),{getOffsetParent:e})}).then(({x:o,y:r,middlewareData:i,placement:s})=>{let l=this.localize.dir()==="rtl",c={top:"bottom",right:"left",bottom:"top",left:"right"}[s.split("-")[0]];if(this.setAttribute("data-current-placement",s),Object.assign(this.popup.style,{left:`${o}px`,top:`${r}px`}),this.arrow){let n=i.arrow.x,b=i.arrow.y,h="",u="",p="",g="";if(this.arrowPlacement==="start"){let m=typeof n=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";h=typeof b=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",u=l?m:"",g=l?"":m}else if(this.arrowPlacement==="end"){let m=typeof n=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";u=l?"":m,g=l?m:"",p=typeof b=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(g=typeof n=="number"?"calc(50% - var(--arrow-size-diagonal))":"",h=typeof b=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(g=typeof n=="number"?`${n}px`:"",h=typeof b=="number"?`${b}px`:"");Object.assign(this.arrowEl.style,{top:h,right:u,bottom:p,left:g,[c]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("sl-reposition")}render(){return Q`
...
`;var Di=(t="value")=>(e,o)=>{let r=e.constructor,i=r.prototype.attributeChangedCallback;r.prototype.attributeChangedCallback=function(s,l,c){var n;let b=r.getPropertyOptions(t),h=typeof b.attribute=="string"?b.attribute:t;if(s===h){let u=b.converter||Lt,g=(typeof u=="function"?u:(n=u?.fromAttribute)!=null?n:Lt.fromAttribute)(c,b.type);this[t]!==g&&(this[o]=g)}i.call(this,s,l,c)}};var Mi=C`
...
`;var lo=class extends I{connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu")}handleClick(t){let e=["menuitem","menuitemcheckbox"],o=t.composedPath(),r=o.find(c=>{var n;return e.includes(((n=c?.getAttribute)==null?void 0:n.call(c,"role"))||"")});if(!r||o.find(c=>{var n;return((n=c?.getAttribute)==null?void 0:n.call(c,"role"))==="menu"})!==this)return;let l=r;l.type==="checkbox"&&(l.checked=!l.checked),this.emit("sl-select",{detail:{item:l}})}handleKeyDown(t){if(t.key==="Enter"||t.key===" "){let e=this.getCurrentItem();t.preventDefault(),t.stopPropagation(),e?.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(t.key)){let e=this.getAllItems(),o=this.getCurrentItem(),r=o?e.indexOf(o):0;e.length>0&&(t.preventDefault(),t.stopPropagation(),t.key==="ArrowDown"?r++:t.key==="ArrowUp"?r--:t.key==="Home"?r=0:t.key==="End"&&(r=e.length-1),r<0&&(r=e.length-1),r>e.length-1&&(r=0),this.setCurrentItem(e[r]),e[r].focus())}}handleMouseDown(t){let e=t.target;this.isMenuItem(e)&&this.setCurrentItem(e)}handleSlotChange(){let t=this.getAllItems();t.length>0&&this.setCurrentItem(t[0])}isMenuItem(t){var e;return t.tagName.toLowerCase()==="sl-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((e=t.getAttribute("role"))!=null?e:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(t=>!(t.inert||!this.isMenuItem(t)))}getCurrentItem(){return this.getAllItems().find(t=>t.getAttribute("tabindex")==="0")}setCurrentItem(t){this.getAllItems().forEach(o=>{o.setAttribute("tabindex",o===t?"0":"-1")})}render(){return Q`
      ...
      ></slot>
    `}};lo.styles=[v,Gi];a([L("slot")],lo.prototype,"defaultSlot",2);lo.define("sl-menu");var Xi=C`
  :host {
    --submenu-offset: -2px;
...
lit-html/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=/_bridgetown/static/index.UY6PUBC2.js.map
